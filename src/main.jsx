...
function Portfolio() {
  ...
  return (
    <main className="portfolio">
      ...
      <section className="p-now" id="now"><div className="p-now-index">NOW</div><div><p className="p-kicker">IN PROGRESS</p><h2>Building the<br /><em>next layer.</em></h2><ul><li><span>01</span>Growing AJX FitClub as a real product and community.</li><li><span>02</span>Exploring reliable AI, automation and market-data systems.</li><li><span>03</span>Learning Rust by building projects—not just reading about them.</li><li><span>04</span>Taking on a small number of thoughtful web and software projects.</li></ul></div></section>
