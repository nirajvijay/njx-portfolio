    ...
    <main className="portfolio p-work-page">
      ...
      <section className="p-work-page-main">
        ...
        <div className="p-projects p-work-page-projects">
          <a className="p-project p-project-johny p-project-card-link" href="/dr-johny/" aria-label="View Dr. Johny’s Dental Care concept"><div className="p-project-meta"><span>FEATURED / WEB CONCEPT</span><span>PALAKKAD</span></div><div className="p-project-body"><p className="p-project-label">A confident new home for everyday smiles</p><h3>Dr. Johny’s<br />Dental Care</h3><p>A mobile-first concept for Dr. Johny’s Multi-Speciality Dental Care Centre, with treatment discovery, patient stories and direct appointment enquiries.</p><span className="p-project-link">Explore the dental concept <span>↗︎</span></span></div></a>
