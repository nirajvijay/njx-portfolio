  ...
  return (
    <main>
      <section className="hero" id="home">
        <nav className="nav shell" aria-label="Main navigation">
          ...
          <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
            ...
            <button className="nav-cta" onClick={goToBooking}>Book your visit <span>↗</span></button>
          </div>
        </nav>
        ...
        <div className="hero-copy shell">
          ...
          <div className="hero-actions">
            <button className="button primary" onClick={goToBooking}>Make an appointment <span>↗</span></button>
      ...
      <section className="intro shell" id="experience">
        ...
        <div className="intro-copy"><p>From a sharp haircut or restorative spa visit to hair colour, grooming and bridal makeup, Bella brings considered care to the looks that matter to you.</p><a className="text-link" href="#visit">Discover Bella <span>↗</span></a></div>
      </section>
      ...
      <section className="services" id="services">
        ...
        <div className="service-grid shell">
          <article className="service-card hair"><span>01</span><div className="service-content"><h3>Hair &amp; spa</h3><p>Haircuts, styling and restorative spa care for a fresh, confident finish.</p></div><button onClick={goToBooking}><span>Explore hair &amp; spa</span><b>↗</b></button></article>
          <article className="service-card beauty"><span>02</span><div className="service-content"><h3>Colour &amp; care</h3><p>Hair colouring, smoothening and tailored treatments for your hair goals.</p></div><button onClick={goToBooking}><span>Explore colour &amp; care</span><b>↗</b></button></article>
          <article className="service-card bridal"><span>03</span><div className="service-content"><h3>Bridal makeup</h3><p>Thoughtful makeup and finishing touches for celebrations worth remembering.</p></div><button onClick={goToBooking}><span>Plan your bridal look</span><b>↗</b></button></article>
        </div>
      </section>
        ...
        <div className="shell booking-wrap"><div className="booking-copy"><p className="eyebrow light">YOUR TIME, RESERVED</p><h2>Let’s make<br />space for <em>you.</em></h2><p>Tell us what you’re thinking about. We’ll help you find the right Bella service and time.</p><a className="call-link" href={`tel:+${phone}`}>Prefer to call? <span>+91 82899 39848</span></a></div>
          <form className="booking-form" onSubmit={submit}>
            {submitted ? <div className="success"><span>✦</span><h3>Thank you.</h3><p>Your appointment request is ready to be followed up by the Bella team.</p><button type="button" onClick={() => setSubmitted(false)}>Make another request</button></div> : <>
              ...
              <button className="button primary full" type="submit">Request an appointment <span>↗</span></button>
    ...
    <main className="portfolio">
      <header className="p-nav">
        ...
        <nav className={menuOpen ? 'p-links open' : 'p-links'}>
          ...
          <a className="p-contact-link" href="#contact" onClick={() => setMenuOpen(false)}>Let’s talk <span>↗</span></a>
        </nav>
      </header>
      ...
      <section className="p-hero" id="top">
        ...
        <div className="p-hero-copy">
          ...
          <div className="p-hero-actions"><a className="p-button" href="#work">See selected work <span>↓</span></a><a className="p-quiet-link" href="https://www.linkedin.com/in/nirajv17/" target="_blank" rel="noreferrer">Follow the journey <span>↗</span></a></div>
        </div>
      ...
      <section className="p-contact" id="contact"><p className="p-kicker">START A CONVERSATION</p><h2>Have an idea<br />that needs a <em>builder?</em></h2><p>I’m open to thoughtful collaborations, early-stage products and useful problems.</p><div className="p-contact-actions"><a className="p-contact-action p-contact-action-primary" href="mailto:nirajv.official27@gmail.com"><span>Email</span><small>Write a note</small><b>↗</b></a><a className="p-contact-action" href="tel:+918921404706"><span>Call</span><small>+91 89214 04706</small><b>↗</b></a><a className="p-contact-action" href="https://www.linkedin.com/in/nirajv17/" target="_blank" rel="noreferrer"><span>LinkedIn</span><small>Follow the work</small><b>↗</b></a></div></section>
