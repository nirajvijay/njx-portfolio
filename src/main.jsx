    ...
    <main className="portfolio p-work-page">
      ...
      <section className="p-work-page-main">
        ...
        <div className="p-projects p-work-page-projects">
          <a className="p-project p-project-johny p-project-card-link" href="/dr-johny/" aria-label="View Dr. Johny’s Dental Care concept"><div className="p-project-meta"><span>FEATURED / WEB CONCEPT</span><span>PALAKKAD</span></div><div className="p-project-body"><p className="p-project-label">A confident new home for everyday smiles</p><h3>Dr. Johny’s<br />Dental Care</h3><p>A mobile-first redesign featuring Dr. Johny, real clinic photography, treatment discovery and direct appointment enquiries.</p><span className="p-project-link">Explore the dental concept <span>↗︎</span></span></div></a>
          ...
          <a className="p-project p-project-bella p-project-card-link" href="/bella/" aria-label="View Bella Family Salon and Spa concept"><div className="p-project-meta"><span>02 / WEB CONCEPT</span><span>BELLA</span></div><div className="p-project-body"><p className="p-project-label">A stronger first impression for a local business</p><h3>Bella<br />Salon &amp; Spa</h3><p>A branded, mobile-first salon website concept with service discovery and a considered appointment flow.</p><span className="p-project-link">View Bella concept <span>↗︎</span></span></div></a>
          <a className="p-project p-project-dental p-project-card-link" href={import.meta.env.DEV ? 'http://127.0.0.1:5173/' : '/dental-square/'} aria-label="View Dr. Rohini's Dental Square redesign concept"><div className="p-project-meta"><span>03 / WEB CONCEPT</span><span>DENTAL SQUARE</span></div><div className="p-project-body"><p className="p-project-label">Specialist care presented with warmth and confidence</p><h3>Dr. Rohini’s<br />Dental Square</h3><p>A mobile-first dental website concept bringing paediatric expertise, specialist services, patient stories and quick booking into one reassuring experience.</p><span className="p-project-link">View dental concept <span>↗︎</span></span></div></a>
        </div>
      </section>
